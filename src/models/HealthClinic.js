...
const addressSchema = new Schema({
    ...
    zipcode: { type: Number, required: [true, 'O preenchimento desse campo é obrigatório'], unique: true },
    _id: false
})


const healthClinicSchema = new Schema({
    type: { type: String, required: [true, 'O preenchimento desse campo é obrigatório'], enum: ['Posto Volante', 'Drive Thru', 'Unidade Basica de Saude', 'UBS', "Unidade de Saude da Família", "USF"] },
    ...
    openingHours: { type: String, required: [true, 'O preenchimento desse campo é obrigatório'] },
